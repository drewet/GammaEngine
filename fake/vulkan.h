...
typedef enum _VK_IMAGE_STATE {
	VK_IMAGE_STATE_DATA_TRANSFER = 0x1300,
	VK_IMAGE_STATE_VKAPHICS_SHADER_READ_ONLY = 0x1301,
	VK_IMAGE_STATE_VKAPHICS_SHADER_WRITE_ONLY = 0x1302,
	VK_IMAGE_STATE_VKAPHICS_SHADER_READ_WRITE = 0x1303,
	VK_IMAGE_STATE_COMPUTE_SHADER_READ_ONLY = 0x1304,
	VK_IMAGE_STATE_COMPUTE_SHADER_WRITE_ONLY = 0x1305,
	VK_IMAGE_STATE_COMPUTE_SHADER_READ_WRITE = 0x1306,
	VK_IMAGE_STATE_MULTI_SHADER_READ_ONLY = 0x1307,
	VK_IMAGE_STATE_TARGET_AND_SHADER_READ_ONLY = 0x1308,
	VK_IMAGE_STATE_UNINITIALIZED = 0x1309,
	VK_IMAGE_STATE_TARGET_RENDER_ACCESS_OPTIMAL = 0x130a,
	VK_IMAGE_STATE_TARGET_SHADER_ACCESS_OPTIMAL = 0x130b,
	VK_IMAGE_STATE_CLEAR = 0x130c,
	VK_IMAGE_STATE_RESOLVE_SOURCE = 0x130d,
	VK_IMAGE_STATE_RESOLVE_DESTINATION = 0x130e,
	VK_IMAGE_STATE_DISCARD = 0x131f,
	VK_IMAGE_STATE_DATA_TRANSFER_SOURCE = 0x1310,
	VK_IMAGE_STATE_DATA_TRANSFER_DESTINATION = 0x1311,
} VK_IMAGE_STATE;
...
typedef enum _VK_PIPELINE_BIND_POINT {
	...
	VK_PIPELINE_BIND_POINT_VKAPHICS = 0x1e01,
